...
internal fun Event.toNewsItem(context: Context) = NewsItem(
    id = id,
    title = name,
...
internal fun Event.toNewsDetailItem(context: Context) = NewsDetailItem(
    id = id,
    name = name,
    description = description,
    organizer = organizer,
...
private fun getDateString(context: Context, dayStart: LocalDate, dayEnd: LocalDate): String {
