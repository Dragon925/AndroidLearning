...
import com.github.dragon925.androidlearning.search.databinding.FragmentSearchByTypeBinding
...
class SearchByTypeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        divider.setDividerInsetStartResource(requireContext(), com.github.dragon925.androidlearning.core.api.R.dimen.spacing_l)
