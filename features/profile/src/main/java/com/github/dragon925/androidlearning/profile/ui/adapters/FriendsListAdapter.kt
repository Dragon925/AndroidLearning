...
import coil3.load
import com.github.dragon925.androidlearning.profile.databinding.ItemFriendBinding
import com.github.dragon925.androidlearning.profile.ui.models.FriendItem

internal class FriendsListAdapter : ListAdapter<FriendItem, FriendsListAdapter.FriendViewHolder>(
        ItemDiffCallback(),
) {
